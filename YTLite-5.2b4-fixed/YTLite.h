...
@interface YTSettingsSectionItemManager ()
- (instancetype)initWithSettingsViewControllerDelegate:(id)delegate;
- (void)updateSectionForCategory:(NSUInteger)category withEntry:(id)entry;
@end

#define LOC(key) [NSBundle.ytl_defaultBundle localizedStringForKey:key value:key table:nil]
...
- (NSArray <YTSettingsSectionItem *> *)sponsorBlockSettings;
@end

@interface YTSettingsConfiguration : NSObject
+ (instancetype)configurationWithSectionItems:(NSArray *)items;
@end
...
- (void)setPlaybackProgressAlwaysVisible:(BOOL)arg1;
@end
...
@interface YTISectionRenderer : NSObject
- (id)contents;
- (BOOL)hasShortsShelfRenderer;
@end

@interface YTIRun : NSObject
@property (nonatomic, copy, readwrite) NSString *text;
@end

@interface YTIShelfRenderer : NSObject
